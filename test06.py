...
# 1. Arithmetic Operator เครื่องหมายคำนวณ
...
# ผลลัพธ์ที่ได้จะมีแค่ True/False
print(10 == 3)
print(10 != 3)
...
# ข้อมูลที่จะใฃ้กับเครื่องหมายนี้จะต้องเป็น True/False และผลลัพธ์ที่ได้จากการใช้เครื่องหมาย True/False
print(not True)
print(not False)
print('----')
